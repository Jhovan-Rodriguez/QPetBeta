					...
					<div class="form-group">
                        <div class="row">
                            <div class="col">
                                ...
                                <input required type="text" placeholder="Apellido paterno" class="form-control" name="apellido_p">
                            </div>
                            <div class="col">
                                <label for="apellido_m">Apellido materno:</label>
                                <input required type="text" placeholder="Apellido materno" class="form-control" name="apellido_m">
                            </div>
                        </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group" >
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input required type="password" placeholder="Confirme contraseña" class="form-control" name="pass2">
                            </div>
